DROP PROCEDURE IF EXISTS bbddmkp.assignSurveys;
CREATE PROCEDURE bbddmkp.`assignSurveys`(surveyId INT,nOperadores INT)
BEGIN
...
#UPDATE `tokens_surveyId` SET attribute_1=nOperadores WHERE attribute_1 = (nOperadores+1);
